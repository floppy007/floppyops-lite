...
[[ ! -d "$INSTALL_DIR/helpers" ]]     && fail "helpers/ directory missing" && VERIFY_OK=false
...
[[ ! -f "$INSTALL_DIR/helpers/pam_auth.py" ]] && fail "helpers/pam_auth.py missing" && VERIFY_OK=false
